...
of the endpoint values).  Call with idum a negative interger to initialize; 
thereafter, don't alter idum between successive deviates in a sequence.  BNMX should
...
k = (*idum)/IQ;			/* Start here when not initialzing.*/
